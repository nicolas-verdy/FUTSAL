...
st.markdown(
    "<div class='red-title'>Nouvel Horaire --> KickOff 20h30 RDV 20h15   (Yann rdv à 16h30 :o)</div>",
    unsafe_allow_html=True      )
...
st.subheader("36 Rue de la Cousinerie")
st.subheader("59650 Villeneuve-d'Ascq")
